...
export default function ApiKeyInvocationRenderer({ body }) {
        ...
        return (
            <Box sx={{ mt: 1, width: '100%' }}>
                <Alert severity='error'>
                    <FormattedMessage
                        id='Apis.Details.Credentials.federated.ApiKeyInvocation.noMethod'
    ...
    // Count enabled methods to decide whether to show radio buttons
    ...
    return (
        <Box sx={{ mt: 1, width: '100%' }}>
            <Typography variant='subtitle2' sx={{ mb: 1 }}>
                <FormattedMessage
                    id='Apis.Details.Credentials.federated.ApiKeyInvocation.title'
            ...
            {enabledCount > 1 && (
                <FormControl component='fieldset' sx={{ mb: 2 }}>
                    <Typography variant='body2' sx={{ mb: 1, fontWeight: 500 }}>
                        <FormattedMessage
                            id='Apis.Details.Credentials.federated.ApiKeyInvocation.method'
                    ...
                    >
                        {headerEnabled && (
                            <FormControlLabel
                                ...
                                label={(
                                    <FormattedMessage
                                        id='Apis.Details.Credentials.federated.ApiKeyInvocation.header.method'
                        ...
                        {queryParamEnabled && (
                            <FormControlLabel
                                ...
                                label={(
                                    <FormattedMessage
                                        id='Apis.Details.Credentials.federated.ApiKeyInvocation.query.method'
                        ...
                        {bodyEnabled && (
                            <FormControlLabel
                                ...
                                label={(
                                    <FormattedMessage
                                        id='Apis.Details.Credentials.federated.ApiKeyInvocation.body.method'
            ...
            {baseUrl && (
                <Typography variant='body2' sx={{ mb: 1.5 }}>
                    <strong>
                        <FormattedMessage
                            id='Apis.Details.Credentials.federated.ApiKeyInvocation.baseUrl'
            ...
            {invocationMethod === 'header' && headerName && (
                <Typography variant='body2' sx={{ mb: 1.5 }}>
                    <strong>
                        <FormattedMessage
                            id='Apis.Details.Credentials.federated.ApiKeyInvocation.header.name'
            ...
            {invocationMethod === 'query' && queryParamName && (
                <Typography variant='body2' sx={{ mb: 1.5 }}>
                    <strong>
                        <FormattedMessage
                            id='Apis.Details.Credentials.federated.ApiKeyInvocation.query.name'
            ...
            {invocationMethod === 'body' && bodyParamName && (
                <Typography variant='body2' sx={{ mb: 1.5 }}>
                    <strong>
                        <FormattedMessage
                            id='Apis.Details.Credentials.federated.ApiKeyInvocation.body.name'
            ...
            {getCurlExample() && (
                <>
                    <Typography variant='body2' sx={{ mb: 1, fontWeight: 500 }}>
                        <FormattedMessage
                            id='Apis.Details.Credentials.federated.ApiKeyInvocation.curl.example'
