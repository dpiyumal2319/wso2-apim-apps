...
class API extends Resource {
     ...
     * Used to populate the plan mapping section during gateway onboarding.
     */
    getEnvironmentRemotePlans(environmentId) {
        return this.client.then((client) => {
            return client.apis['Environments'].getEnvironmentRemotePlans(
                { environmentId },
                this._requestMetaData(),
            );
        });
